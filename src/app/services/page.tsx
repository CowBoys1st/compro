  ...
  return (
    <section className="max-container py-24 padding-container">
      <div className="text-center mb-12">
        ...
        <p className="regular-16 text-gray-90">We offer a wide range of services to meet your IT needs.</p>
      </div>
      ...
      <div className="flex flex-col gap-12 lg:flex-row lg:flex-wrap lg:justify-center">
        <div className="flex flex-col lg:flex-row gap-6 bg-gray-10 p-6 rounded-lg shadow-md w-full lg:w-[48%] hover:shadow-2xl">
          <div className="relative w-full h-32 lg:w-48 lg:h-auto flex-shrink-0">
            <Image src="/software-dev.webp" alt="Custom Software Development" layout="fill" objectFit="cover" className="rounded-lg" />
          </div>
          <div>
            <h3 className="bold-32 pb-10">Custom Software Development Services</h3>
            <p className="regular-16 text-gray-90">
        ...
        <div className="flex flex-col lg:flex-row gap-6 bg-gray-10 p-6 rounded-lg shadow-md w-full lg:w-[48%] hover:shadow-2xl">
          <div className="relative w-full h-32 lg:w-48 lg:h-auto flex-shrink-0">
            <Image src="/integration-service.webp" alt="Middleware / Integration Services" layout="fill" objectFit="cover" className="rounded-lg" />
          </div>
          <div>
        ...
        <div className="flex flex-col lg:flex-row gap-6 bg-gray-10 p-6 rounded-lg shadow-md w-full lg:w-[48%] hover:shadow-2xl">
          <div className="relative w-full h-32 lg:w-48 lg:h-auto flex-shrink-0">
            <Image src="/managed-it.webp" alt="Managed Services" layout="fill" objectFit="cover" className="rounded-lg" />
          </div>
          <div>
        ...
        <div className="flex flex-col lg:flex-row gap-6 bg-gray-10 p-6 rounded-lg shadow-md w-full lg:w-[48%] hover:shadow-2xl">
          <div className="relative w-full h-32 lg:w-48 lg:h-auto flex-shrink-0">
            <Image src="/data-warehouse.webp" alt="Data Warehouse Business Intelligence" layout="fill" objectFit="cover" className="rounded-lg" />
          </div>
          <div>
