...
const Services = () => {
  return (
    <section className="max-container py-24">
      ...
      <div className="flex flex-col gap-12 lg:flex-row lg:flex-wrap lg:justify-between">
        {/* Service 1 */}
        <div className="flex flex-col lg:flex-row gap-6 bg-gray-10 p-6 rounded-lg shadow-md w-full lg:w-[48%]">
          ...
          <div>
            <h3 className="bold-32">Custom Software Development Services</h3>
        ...
        <div className="flex flex-col lg:flex-row gap-6 bg-gray-10 p-6 rounded-lg shadow-md w-full lg:w-[48%]">
          ...
          <div>
            <h3 className="bold-32">Middleware / Integration Services</h3>
            <p className="regular-16 text-gray-30">
        ...
        <div className="flex flex-col lg:flex-row gap-6 bg-gray-10 p-6 rounded-lg shadow-md w-full lg:w-[48%]">
          ...
          <div>
            <h3 className="bold-32">Managed Services</h3>
            <p className="regular-16 text-gray-30">
        ...
        <div className="flex flex-col lg:flex-row gap-6 bg-gray-10 p-6 rounded-lg shadow-md w-full lg:w-[48%]">
          ...
          <div>
            <h3 className="bold-32">Data Warehouse Business Intelligence</h3>
            <p className="regular-16 text-gray-30">
